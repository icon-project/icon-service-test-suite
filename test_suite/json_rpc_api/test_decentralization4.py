...
class TestDecentralization4(Base):

    def test_4_decentralization(self):
        ...
        delegation_data3 = [(wallet, minimum_delegate_amount + 10 - index) for index, wallet in enumerate(preps[20:25])]
